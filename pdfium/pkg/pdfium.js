export default (() => {
  ...
  return (
    function(moduleArg = {}) {
      ...
      var _FPDFImageObj_GetImagePixelSize = Module["_FPDFImageObj_GetImagePixelSize"] = createExportWrapper("FPDFImageObj_GetImagePixelSize");
